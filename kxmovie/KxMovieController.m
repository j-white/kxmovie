...
@interface KxMovieController () {
    ...
    NSObject<KxMovieRenderer> *_renderer;
}
                               ...
                               parameters: (NSDictionary *) parameters
{
    ...
    return [[KxMovieController alloc] initWithContentPath: path renderer: renderer parameters: parameters];
}
